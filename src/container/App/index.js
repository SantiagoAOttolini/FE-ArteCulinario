...
import bulking from '../../components/views/Analyzer/Bulking-Cutting/bulking'
import cutting from '../../components/views/Analyzer/Bulking-Cutting/cutting'
    ...
    <Suspense fallback={<div>Loading...</div>}>
      ...
      <div style={{ paddingTop: '69px', minHeight: 'calc(100vh - 80px)' }}>
        <Switch>
          ...
          <Route
            exact
            path='/analyzerMetabolic'
            component={analyzerMetabolic}
          />
          <Route exact path='/bulking' component={Auth(bulking, null)} />
          <Route exact path='/cutting' component={Auth(cutting, null)} />
        </Switch>
      </div>
    </Suspense>
  )
